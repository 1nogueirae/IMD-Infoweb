function inserirPessoa() {
    ...
    let nomeElement = document.getElementById("input-nome").value;
    let idadeElement = document.getElementById("input-idade").value;
    let cidadeElement = document.getElementById("input-cidade").value;

    if (nomeElement !== "" && idadeElement !== "" && cidadeElement !== "Selecione") {
...
function atualizarTabela() {
    ...
    listaCadastrada.forEach((pessoa, index) => {
        tbody.innerHTML += `
            <tr>
...
function listaCidades() {
    ...
    const cidades = [
        "Selecione", "Acari", "Açu", "Afonso Bezerra", "Água Nova", "Alexandria", "Almino Afonso",
    ...
    cidades.forEach(cidade => {
        lista.innerHTML += `<option value="${cidade}">${cidade}</option>`;
    });
}

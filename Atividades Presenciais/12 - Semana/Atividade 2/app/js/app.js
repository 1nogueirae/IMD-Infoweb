...
function tocarMusica(musica) {
    const tocandoAgora = document.querySelector('.tocando-agora p');
...
const form = document.getElementById('adicionar-musicas-form');
form.addEventListener('submit', function (e) {
    ...
    const radioInicio = document.getElementById('adicionar-inicio');
    const radioFim = document.getElementById('adicionar-fim');

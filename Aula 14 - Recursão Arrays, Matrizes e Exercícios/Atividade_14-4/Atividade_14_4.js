...
function subtrairMatrizes(m1,m2) {
    ...
    if (m1.length == 0) {
        ...
        resultado.push(subtrairArrays(m1[0], m2[0]));
        resultado = resultado.concat(subtrairMatrizes(m1.slice(1), m2.slice(1)));
    }
    return resultado;
}
...
function subtrairArrays(l1, l2) {
    ...
    if (l1.length == 0) {
        ...
        resultado.push(l1[0] - l2[0]);
        resultado = resultado.concat(subtrairArrays(l1.slice(1), l2.slice(1)));
    }
    return resultado;
}

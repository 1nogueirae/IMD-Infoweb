function pitagoras() {
    // Nas 3 ocorrências, a função "ler_entrada()" estava sendo chamada como "ler__entrada()".
    var h = ler_entrada("hipotenusa");
    var c1 = ler_entrada("cateto1");
    var c2 = ler_entrada("cateto2");

    
    var sq_h = quadrado(h); // Tinha um parêntese a mais aqui.
    var sq_c1 = quadrado(c1);
    var sq_c2 = quadrado(c2); // Tinha um quadrado dentro do outro aqui.
...
function quadrado(x) {
    // A função estava somando, ao invés de multiplicar
    return x * x;
}
